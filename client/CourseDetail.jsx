...
const CourseDetail = () => {
        ...
        const fetchCourseData = async () => {
            try {
                ...
                if (user) {
                    ...
                    const alreadyBought = dashboardRes.data.data.some(c => c._id === courseId);
    ...
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto bg-white shadow-xl rounded-lg">
            ...
            <p className="text-xl font-medium text-gray-700 mb-6">{course.description}</p>
            ...
            <ul className="list-disc ml-6 space-y-2 mb-8 text-gray-800">
                ...
                {course.lectures && course.lectures.map((lecture, index) => (
                    <li key={lecture._id} className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center p-4 bg-gray-100 rounded-lg">
                <p className="text-3xl font-extrabold text-blue-600">Price: ₹{course.price.toFixed(2)}</p>
